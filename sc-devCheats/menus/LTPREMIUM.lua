    ...
    function()
        ...
        while Enabled do
            ...
            if LTPREMIUM.IsMenuOpened("MainMenu") then
                ...
                elseif LTPREMIUM.MenuButton("~r~→  ~s~[👿] Grief Оptions & Premium", "GriefMenu") then
                ...
                LTPREMIUM.Display()
            elseif LTPREMIUM.IsMenuOpened("GriefMenu") then
                if LTPREMIUM.Button("Community Service All Players") then
                    TriggerServerEvent("esx_communityservice:sendToCommunityService", -1, 69696969669669699)
